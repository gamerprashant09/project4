...
export default function SecondScreen({ onNext }) {
  const thankYouCards = [
     {
      text: "Butki maan jao na , please forgive me",
      icon: Heart,
    ...
    {
      text: "And the last i am sorry for my all mistakes i done in my life",
      icon: Heart,
      gradient: "from-red-400 via-red-500 to-fuchsia-500",
